...
uint256 hashGenesisBlock("0x82562afa01c51aefa10290071e219cf75cabd2bea21d4af8056bba6c5665159f");
...
const string strMessageMagic = "Washerz Signed Message:\n";
...
{
    int64 nSubsidy = 32.3439878234 * COIN;
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // Washerz: 0.35 days
static const int64 nTargetSpacing = 120; // Washerz: 2 minute block
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Washerz miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Washerz", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x40c8729d6ad2a71462a99c44ba18397a23f4affd3b1d24db564cbcb3271d930f");
    }
	...
	// Genesis block:
	// block.nTime = 1406140690 
	// block.nNonce = 387436698
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "KIEV- July 23, 2014 (Reuters) Pro-Russian rebels have shot down two Ukrainian fighter jets, a spokesman for Ukraine's military operations said on Wednesday.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1407192900;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 999495;

        if (fTestNet)
        {
            block.nTime    = 1406135883;
            block.nNonce   = 387436698;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x40c8729d6ad2a71462a99c44ba18397a23f4affd3b1d24db564cbcb3271d930f"));
